...
import { CheckCircle, Award, Scale, Music } from "lucide-react";
...
const credentials = [
  ...
  { icon: CheckCircle, text: "Managed Three Highly Successful Title Company Offices" },
];
    ...
    <section id="about" className="py-24 bg-[#FAFAF8]" ref={ref}>
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="section-eyebrow mb-4">About the Firm</p>
            <h2
            ...
            <div className="space-y-5 text-[#3a3a3a] leading-relaxed" style={{ fontFamily: "'Lato', sans-serif", fontSize: "1rem" }}>
              <p>
                Kelly Satterwhite founded The Satterwhite Law Firm, PLLC after a remarkable career that spans
                the concert stage, the military, and the boardroom. A native of Baytown, Texas, Kelly earned a
                degree in French Horn Performance from Louisiana State University in 2003 before dedicating
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <button
                ...
                className="btn-outline-white text-xs border-[#1D2B5F] text-[#1D2B5F] hover:bg-[#1D2B5F] hover:text-white"
